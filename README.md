...
Group Project By Ange and Damscene:
...
Handle the 0 flag character for non-custom conversion spec.

12. Every time that I wanted to give up, if I saw an interesting textile, print whatever,
suddenly I would see a collection Handle the - flag character for non-custom conversion specifiers;
